...
export default function ThrillerBooks() {
  ...
  const FetchBooks = async () => {
    try {
      ...
      const response = await axios.get(
        `https://www.googleapis.com/books/v1/volumes?q=subject:thriller&startIndex=${startIndex}&maxResults=${maxResults}`
      );
  ...
  return (
    <div className="container my-4" style={{ backgroundColor: "#F8F4F0", borderRadius: "12px" }}>
      <h2 className="mb-4 fw-bold" style={{ color: "#3E2F5B"}}>Thriller Books</h2>
      <div className="row">
