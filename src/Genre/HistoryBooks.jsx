...
export default function HistoryBooks(){
    ...
    const FetchBooks = async ()=> {
        ...
        const response = await axios.get(
            `https://www.googleapis.com/books/v1/volumes?q=history+books&startIndex=${startIndex}&maxResults=${maxResults}`
        );
      ...
      <h2 className="mb-4 fw-bold" style={{ color: "#3E2F5B"}}>History Books </h2>
      <div className="row">
