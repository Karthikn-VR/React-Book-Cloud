...
export default function CookingBooks() {
  ...
  const FetchBooks = async () => {
    try {
      ...
      const response = await axios.get(
        `https://www.googleapis.com/books/v1/volumes?q=subject:cooking&startIndex=${startIndex}&maxResults=${maxResults}`
      );
  ...
  return (
    <div className="container my-4" style={{ backgroundColor: "#F8F4F0", borderRadius: "12px" }}>
      <h2 className="mb-4 fw-bold" style={{ color: "#3E2F5B"}}>Cooking Books</h2>
      <div className="row">
