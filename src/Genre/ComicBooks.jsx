...
export default function ComicsBooks(){
    ...
    const FetchBooks = async ()=> {
        ...
        const response = await axios.get(
            `https://www.googleapis.com/books/v1/volumes?q=comics+books&startIndex=${startIndex}&maxResults=${maxResults}`
        );
      ...
      <h2 className="mb-4 fw-bold" style={{ color: "#3E2F5B"}}>Comic Books</h2>
      <div className="row">
